...
import { FileNode, WorkRequest, PlanIR, CritiqueIR, SpecIR, ExecutionIR, ValidationIR, ActiveAgent, AgentLogEntry, Workspace, ChatMessage, AgentLog, ToastNotification, RoundtableSession } from '../types';
...
export function useSimulation() {
  ...
  return {
    ...
    addAgent: (agentData: { name: string; role: string; model?: string; systemPrompt?: string; temperature?: number; topP?: number; maxTokens?: number; avatarPrompt?: string; avatarUrl?: string }) => BackendService.addAgent(agentData),
